...
function generate_data() {
	...
	waste_time();
	apiTools.post("PEACE OUT! #notgradingthis #letsgoalex")
	waste_time();
	apiTools.logout()
...
function test_basic_functionality() {
    ...
    apiTools.get_hub_users(5, '{"status":1,"users":["Alex","Jessica","Patti","Andy","Christos"]}')
    apiTools.user_tweets('Phil',5,-1,'{"status":1,"tweets":[]}')
    apiTools.user_tweets('Stephen',5,-1,'{"status":1,"tweets":[{"username":"Stephen","message":"HAHA DUKE LOST","creation_time":"1395601501"},{"username":"Stephen","message":"MARCH MADNESS #ncaa #basketball #hoops #notworking #march #madness #marchmadness #hashtag","creation_time":"1395601500"}]}')
    apiTools.user_tweets_paginated('Alex',2,'{"status":1,"tweets":[{"username":"Alex","message":"Welcome to CMU Flitter, HW 7 for 15-415 brought to you by me. #fun #haha #goodluck #hashtag","creation_time":"1395601467"},{"username":"Alex","message":"Hello CMU","creation_time":"1395601465"}]}')
    apiTools.search("#2048",5,'{"status":1,"tweets":[{"username":"Patti","message":"I beat #2048 !!!!","creation_time":"1395604288"},{"username":"Alex","message":"If you are sick of this, check out: http:\/\/gabrielecirulli.github.io\/2048\/ #addicted #2048","creation_time":"1395604280"}]}')
    ...
    apiTools.timeline(3,-1,'{"status":1,"tweets":[{"username":"Alex","message":"If you are sick of this, check out: http:\/\/gabrielecirulli.github.io\/2048\/ #addicted #2048","creation_time":"1395601498"},{"username":"Vagelis","message":"PEACE OUT! #notgradingthis #letsgoalex","creation_time":"1395601484"},{"username":"Vagelis","message":"Viva Korea!!","creation_time":"1395601483"}]}')
